...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { gross_amount: @price.gross_amount, place_id: @price.place_id, vehicle_size_id: @price.vehicle_size_id, wash_type_id: @price.wash_type_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { gross_amount: @price.gross_amount, place_id: @price.place_id, vehicle_size_id: @price.vehicle_size_id, wash_type_id: @price.wash_type_id } }
